...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="content1">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <asp:Label ID="lblGame1" runat="server" Text="Game 1 Information"></asp:Label></div>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <asp:Label ID="lblGame2" runat="server" Text="Game 2 Information"></asp:Label></div>
        <div class="panel-body">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <asp:Label ID="lblGame3" runat="server" Text="Game 3 Information"></asp:Label></div>
        <div class="panel-body">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <asp:Label ID="lblGame4" runat="server" Text="Game 4 Information"></asp:Label></div>
        <div class="panel-body">
